jsPsych.plugins["canvas-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    // display stimulus
	  ...
	  html += '<canvas id="second-canvas" width="1600" height="200" style="border:2px solid;"></canvas>'
...
var seedbonusheader = new fabric.Text('Seed #', { left: 500, top: 100, shadow: 'rgba(0,0,0,0.3) 5px 5px 5px',   fontFamily: 'Hoefler Text' });
var seedbonus = new fabric.Text(`${PointBonus}`, { left: 625, top: 100 });
...
canvas2.add(seedfb)
canvas2.add(seedbonusheader)
canvas2.add(seedbonus)
